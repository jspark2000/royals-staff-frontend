        ...
        <v-card class="pa-2" elevation="3">
          ...
          <v-card-text class="font-weight-medium mt-lg-3">
            <EasyDataTable
              ...
              :items="items"
              :rows-per-page="10"
              table-class-name="attendance-register-table"
              theme-color="#1d90ff"
              show-index
              alternating
...
.attendance-register-table {
  ...
  --easy-table-header-item-padding: 10px 8px;
  ...
  --easy-table-body-item-padding: 10px 8px;
